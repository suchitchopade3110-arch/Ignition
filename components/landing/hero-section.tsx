...
export function HeroSection() {
  ...
  return (
    <section className="relative min-h-[90vh] pt-32 pb-16 flex items-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-0 flex items-center justify-center pointer-events-none opacity-10 blur-xl">
        ...
        <div className="flex flex-col items-center justify-center text-center max-w-4xl mx-auto">
          ...
          >
            ...
            <motion.div variants={itemVariants} className="flex flex-wrap items-center justify-center gap-4">
              <Link 
                href="/login"
                className="group flex items-center justify-center gap-2 px-8 py-4 bg-primary text-primary-foreground text-base font-semibold rounded-full hover:bg-primary/90 transition-all shadow-[0_0_20px_rgba(255,69,0,0.3)] hover:shadow-[0_0_30px_rgba(255,69,0,0.6)] hover:-translate-y-0.5"
              >
                Get Started
              ...
              <a 
                href="#demo"
                className="flex items-center justify-center gap-2 px-8 py-4 bg-secondary border border-border text-foreground text-base font-medium rounded-full hover:bg-secondary/80 transition-colors"
              >
                Watch Demo
              </a>
              <a 
                ...
                target="_blank"
                rel="noreferrer"
                className="flex items-center justify-center gap-2 px-6 py-4 bg-transparent text-muted-foreground hover:text-foreground transition-colors"
              >
