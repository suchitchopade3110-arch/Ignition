      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between">
            <Link href="/loading" className="flex items-center group">
              <div className="relative h-14 w-24 flex items-center justify-center transition-transform group-hover:scale-105">
                <Image 
                  src="/logo-full.png" 
                  alt="Ignition" 
                  fill
              ...
              <span className="text-2xl font-bold tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-primary to-blue-400 hidden sm:block">IGNITION</span>
            </Link>
